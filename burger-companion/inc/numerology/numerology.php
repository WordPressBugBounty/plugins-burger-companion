...
require BURGER_COMPANION_PLUGIN_DIR . 'inc/numerology/features/numerology-slider.php';
...
if ( ! function_exists( 'burger_companion_astrocare_frontpage_sections' ) ) :
	function burger_companion_astrocare_frontpage_sections() {	
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/numerology/sections/section-slider.php';
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/numerology/sections/section-astroform.php';
