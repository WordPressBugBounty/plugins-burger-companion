	...
	class Cozipress_social_section_upgrade extends WP_Customize_Control {
		public function render_content() { 
				...
				<?php }elseif('CoraPress' == $theme->name){ ?>
					...
					<a class="customizer_CoziPress_social_upgrade_section up-to-pro" href="https://burgerthemes.com/corapress-pro/" target="_blank" style="display: none;"><?php _e('More Icons Available in CoraPress Pro','cozipress'); ?></a>			
				<?php }else{ ?>		
