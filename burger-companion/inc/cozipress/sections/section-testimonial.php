		...
		if($hs_testimonial == '1'){	
			...
			<section id="testimonials-section" class="home-testimonial testimonials-section st-py-default shapes-section" style="background:url('<?php echo esc_url($testimonial_bg_img); ?>') no-repeat <?php echo esc_attr($testimonial_back_attach); ?> center / cover rgba(0,0,0,0.85);background-blend-mode:multiply;">
				<div class="container">
								...
								foreach ( $testimonials as $test_item ) {
									...
									<div class="testimonials-item shapes-section">
										...
										if ($current_theme->get('Name') === 'CoraPress') { ?>
											<div class="lg-shape32"><img src="<?php echo esc_url(BURGER_COMPANION_PLUGIN_URL); ?>/inc/corapress/images/clipArt/testimonials/shape3.png" alt="image"></div>
											<div class="lg-shape33"><img src="<?php echo esc_url(BURGER_COMPANION_PLUGIN_URL); ?>/inc/corapress/images/clipArt/testimonials/shape4.png" alt="image"></div>
											<div class="lg-shape34"><img src="<?php echo esc_url(BURGER_COMPANION_PLUGIN_URL); ?>/inc/corapress/images/clipArt/testimonials/shape5.png" alt="image"></div>
											<div class="lg-shape35"><img src="<?php echo esc_url(BURGER_COMPANION_PLUGIN_URL); ?>/inc/corapress/images/clipArt/testimonials/shape6.png" alt="image"></div>
										<?php } else { ?>
					...
					$current_theme = wp_get_theme();
					if ($current_theme->get('Name') === 'CoraPress') { ?>
						<div class="lg-shape21"><img src="<?php echo esc_url(BURGER_COMPANION_PLUGIN_URL); ?>/inc/corapress/images/clipArt/testimonials/shape1.png" alt="image"></div>
					<div class="lg-shape21bottom"><img src="<?php echo esc_url(BURGER_COMPANION_PLUGIN_URL); ?>/inc/corapress/images/clipArt/testimonials/shape2.png" alt="image"></div>
					<?php } else { ?>
