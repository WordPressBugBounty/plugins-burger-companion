	...
	class Spintech_info_section_upgrade extends WP_Customize_Control {
		public function render_content() { 
				...
				<?php }elseif ( 'Softura' == $theme->name){ ?>	
					...
					<a class="customizer_spintech_info_upgrade_section up-to-pro"  href="https://burgerthemes.com/softura-pro/" target="_blank" style="display: none;"><?php _e('More Info Available in Softura Pro','spintech'); ?></a>
