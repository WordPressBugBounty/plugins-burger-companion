...
function burger_companion_hotelgalaxy_admin_enqueue_scripts(){
...
add_action( 'admin_enqueue_scripts', 'burger_companion_hotelgalaxy_admin_enqueue_scripts' );
...
if ( ! function_exists( 'burger_companion_hotelgalaxy_above_header_sections' ) ) :
    function burger_companion_hotelgalaxy_above_header_sections() {  
       require BURGER_COMPANION_PLUGIN_DIR . 'inc/hotel-galaxy/sections/section-above-header.php';     
   }
   add_action( 'hotel_galaxy_Above_Header', 'burger_companion_hotelgalaxy_above_header_sections' );
endif;

if ( ! function_exists( 'burger_companion_hotelgalaxy_frontpage_sections' ) ) :
    function burger_companion_hotelgalaxy_frontpage_sections() {  
   ...
   add_action( 'hotel_galaxy_frontpage_sections', 'burger_companion_hotelgalaxy_frontpage_sections' );
endif;

if ( ! function_exists( 'burger_companion_hotelgalaxy_footer_sections' ) ) :
    function burger_companion_hotelgalaxy_footer_sections() {  
        require BURGER_COMPANION_PLUGIN_DIR . 'inc/hotel-galaxy/sections/section-footerbootom.php';
    }
    add_action( 'hotel_galaxy_footer_sections', 'burger_companion_hotelgalaxy_footer_sections' );
endif;
