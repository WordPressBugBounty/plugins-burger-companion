<?php
if ( ! function_exists( 'burger_companion_hotelgalaxy_dynamic_style' ) ) {
  function burger_companion_hotelgalaxy_dynamic_style(){   
   ...
   $output_css = '';         
     ...
     */
     ...
     if( $logo_width !== '' ) {
      ...
      add_action('wp_enqueue_scripts', 'burger_companion_hotelgalaxy_dynamic_style' );
    }
