<?php
function burger_companion_hotelgalaxy_typography( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	

	$wp_customize->add_panel(
		'burger_companion_hotelgalaxy_typography', array(
			'priority' => 38,
	...
	$wp_customize->add_section(
        'burger_companion_hotelgalaxy_typography',
        array(
        	'priority'      => 1,
            'title' 		=> __('Body Typography','hotel-galaxy'),
			'panel'  		=> 'burger_companion_hotelgalaxy_typography',
		)
    );
	...
	if ( class_exists( 'Burger_Customizer_Range_Control' ) ) {
		...
		new Burger_Customizer_Range_Control( $wp_customize, 'hotelgalaxy_body_font_size', 
			array(
				...
				'section'  => 'burger_companion_hotelgalaxy_typography',
				'priority'      => 2,
                'input_attr'    => array(
                        'min'           => 0,
                        'max'           => 50,
...
add_action( 'customize_register', 'burger_companion_hotelgalaxy_typography' );