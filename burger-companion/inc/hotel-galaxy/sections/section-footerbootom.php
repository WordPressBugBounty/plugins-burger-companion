 <!--===// Start: Footer Bottom =================================--> 
 <?php  
 if ( ! function_exists( 'burger_hotelgalaxy_footerbottom' ) ) :
 	function burger_hotelgalaxy_footerbottom() { 
        $s_h_footer_bottom          = get_theme_mod( 's_h_footer_bottom', true );
        $footerbottom_contents      = get_theme_mod( 'footerbottom_contents', hotel_galaxy_get_footerbottom_default() );
...
if ( function_exists( 'burger_hotelgalaxy_footerbottom' ) ) {
  $section_priority = apply_filters( 'hotelgalaxy_section_priority', 11, 'burger_hotelgalaxy_footerbottom' );
  add_action( 'hotel_galaxy_footer_sections', 'burger_hotelgalaxy_footerbottom', absint( $section_priority ) );
}