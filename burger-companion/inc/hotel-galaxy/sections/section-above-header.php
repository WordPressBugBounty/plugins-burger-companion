 <!--===// Start: Above Header =================================--> 
 <?php  
 if ( ! function_exists( 'burger_hotelgalaxy_abover_header' ) ) :
 	function burger_hotelgalaxy_abover_header() {  		
 		...
 		$header_contents               	= get_theme_mod( 'header_office_contents', hotel_galaxy_get_header_office_default() ); 		
 		?> 	 		
 			...
 			<div class="container d-flex content-center">
 				...
 				<ul class="nav social_media">
 					<?php if ($s_h_social_media) { ?>
 						<?php
 						$socialmedia_contents = get_theme_mod('socialmedia_contents', hotel_galaxy_get_socialmedia_default());
 ...
 if ( function_exists( 'burger_hotelgalaxy_abover_header' ) ) {
 	$section_priority = apply_filters( 'hotelgalaxy_section_priority', 12, 'burger_hotelgalaxy_abover_header' );
 	add_action( 'hotel_galaxy_Above_Header', 'burger_hotelgalaxy_abover_header', absint( $section_priority ) );
 }
