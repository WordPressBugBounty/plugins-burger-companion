...
jQuery(document).ready(function () {
    ...
    burger_companion_theme_controls.on('change','.customizer-repeater-image2-control', function(){
        burger_companion_customizer_repeater_refresh_general_control_values();
        return false;
...
if(split_add_more_button_split=="Add New Slid")
{
 if(jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider,#exist_burger_companion_Anexa_Slider,#exist_burger_companion_CoziWeb_Slider,#exist_burger_companion_CoziPlus_Slider,#exist_burger_companion_CoziBee_Slider,#exist_burger_companion_Cozigo_Slider').val()>=3)
 {
...
if(jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider,#exist_burger_companion_Anexa_Slider,#exist_burger_companion_CoziWeb_Slider,#exist_burger_companion_CoziPlus_Slider,#exist_burger_companion_CoziBee_Slider,#exist_burger_companion_Cozigo_Slider').val()<3)
{
   ...
   jQuery('#exist_burger_companion_CoziPress_Slider,#exist_burger_companion_Sipri_Slider,#exist_burger_companion_Anexa_Slider,#exist_burger_companion_CoziWeb_Slider,#exist_burger_companion_CoziPlus_Slider,#exist_burger_companion_CoziBee_Slider,#exist_burger_companion_Cozigo_Slider').val(new_service_add_val);  
}
}
...
if(split_add_more_button_split=="Add New Serv")
{
 if(jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service,#exist_burger_companion_Anexa_Service,#exist_burger_companion_CoziWeb_Service,#exist_burger_companion_CoziPlus_Service,#exist_burger_companion_CoziBee_Service,#exist_burger_companion_Cozigo_Service').val()>=3)
 {
...
burger_companion_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
  ...
  if (typeof    jQuery(this).parent() !== 'undefined') {
    jQuery(this).parent().hide(500, function(){
        ...
        if(split_delete_button_split=="Delete Servi")
        {
            jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service,#exist_burger_companion_Anexa_Service,#exist_burger_companion_CoziWeb_Service,#exist_burger_companion_CoziPlus_Service,#exist_burger_companion_CoziBee_Service,#exist_burger_companion_Cozigo_Service').val(parseInt(jQuery('#exist_burger_companion_CoziPress_Service,#exist_burger_companion_Sipri_Service,#exist_burger_companion_Anexa_Service,#exist_burger_companion_CoziWeb_Service,#exist_burger_companion_CoziPlus_Service,#exist_burger_companion_CoziBee_Service,#exist_burger_companion_Cozigo_Service').val())-1); 
        }


        if(split_delete_button_split=="Delete Testi")
        {
            jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial,#exist_burger_companion_Anexa_Testimonial,#exist_burger_companion_CoziWeb_Testimonial,#exist_burger_companion_CoziPlus_Testimonial,#exist_burger_companion_CoziBee_Testimonial,#exist_burger_companion_Cozigo_Testimonial').val(parseInt(jQuery('#exist_burger_companion_CoziPress_Testimonial,#exist_burger_companion_Sipri_Testimonial,#exist_burger_companion_Anexa_Testimonial,#exist_burger_companion_CoziWeb_Testimonial,#exist_burger_companion_CoziPlus_Testimonial,#exist_burger_companion_CoziBee_Testimonial,#exist_burger_companion_Cozigo_Testimonial').val())-1); 
        }
...
// Kundoo
if(split_delete_button_split=="Delete Count")
{
    console.log( jQuery('#exist_burger_companion_Kundoo_Country').val(parseInt(jQuery('#exist_burger_companion_Kundoo_Country').val())-1));  
}

if(split_delete_button_split=="Delete Socia")
{
    console.log( jQuery('#exist_burger_companion_Kundoo_Social').val(parseInt(jQuery('#exist_burger_companion_Kundoo_Social').val())-1));  
}

if(split_delete_button_split=="Delete Payme")
{
    console.log( jQuery('#exist_burger_companion_Kundoo_PaymentMethods').val(parseInt(jQuery('#exist_burger_companion_Kundoo_PaymentMethods').val())-1));  
}

if(split_delete_button_split=="Delete Slide")
{
    console.log( jQuery('#exist_burger_companion_Kundoo_Slide').val(parseInt(jQuery('#exist_burger_companion_Kundoo_Slide').val())-1));  
}

if(split_delete_button_split=="Delete Servi")
{
    console.log( jQuery('#exist_burger_companion_Kundoo_Service').val(parseInt(jQuery('#exist_burger_companion_Kundoo_Service').val())-1));  
}

if(split_delete_button_split=="Delete Desig")
{
    console.log( jQuery('#exist_burger_companion_Kundoo_Design').val(parseInt(jQuery('#exist_burger_companion_Kundoo_Design').val())-1));  
}

if(split_delete_button_split=="Delete Testi")
{
    console.log( jQuery('#exist_burger_companion_Kundoo_Testimonial').val(parseInt(jQuery('#exist_burger_companion_Kundoo_Testimonial').val())-1));  
}
