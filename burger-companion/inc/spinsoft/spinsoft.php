...
require BURGER_COMPANION_PLUGIN_DIR . 'inc/spinsoft/features/spintech-funfact.php';
require BURGER_COMPANION_PLUGIN_DIR . 'inc/spinsoft/features/spintech-testimonial.php';
...
if ( ! function_exists( 'burger_companion_spintech_frontpage_sections' ) ) :
	function burger_companion_spintech_frontpage_sections() {	
		...
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/spinsoft/sections/section-funfact.php';
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/spinsoft/sections/section-testimonial.php';
