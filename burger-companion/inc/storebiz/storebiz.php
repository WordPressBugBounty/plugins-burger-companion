...
// require BURGER_COMPANION_PLUGIN_DIR . 'inc/storebiz/features/storebiz-general.php';
...
// require BURGER_COMPANION_PLUGIN_DIR . 'inc/storebiz/features/storebiz-cta.php';
// require BURGER_COMPANION_PLUGIN_DIR . 'inc/storebiz/features/storebiz-design.php';
// require BURGER_COMPANION_PLUGIN_DIR . 'inc/storebiz/features/storebiz-info.php';
...
if ( ! function_exists( 'burger_companion_storebiz_frontpage_sections' ) ) :
	function burger_companion_storebiz_frontpage_sections() {	
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/storebiz/sections/section-slider.php';
