...
require BURGER_COMPANION_PLUGIN_DIR . 'inc/rasam/features/appetizer-recepies.php';
...
if ( ! function_exists( 'burger_companion_appetizer_frontpage_sections' ) ) :
	function burger_companion_appetizer_frontpage_sections() {	
		...
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/rasam/sections/section-recepies.php';
    }
