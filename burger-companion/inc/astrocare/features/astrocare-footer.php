...
function astrocare_footer_setting( $wp_customize ) {
    ...
    class Astrocare_social_section_upgrade extends WP_Customize_Control {
    	public function render_content() { 
    		...
    		if ( 'Numerology' == $theme->name){
    			?>	
    			<a class="customizer_Astrocare_social_upgrade_section up-to-pro" href="<?php echo esc_url('https://burgerthemes.com/numerology-pro/');?>" target="_blank" style="display: none;"><?php _e('More Icons Available in Numerology Pro','numerology'); ?></a>
    		<?php }else{ ?>		
    ...
    class Astrocare_payment_icon_section_upgrade extends WP_Customize_Control {
    	public function render_content() { 
    		...
    		if ( 'Numerology' == $theme->name){
    			?>	
    			<a class="customizer_Astrocare_payment_icon_upgrade_section up-to-pro" href="<?php echo esc_url('https://burgerthemes.com/numerology-pro/');?>" target="_blank" style="display: none;"><?php _e('More Icons Available in Numerology Pro','numerology'); ?></a>
    		<?php }else{ ?>		
