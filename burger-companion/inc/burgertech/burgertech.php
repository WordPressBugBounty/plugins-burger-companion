...
require BURGER_COMPANION_PLUGIN_DIR . 'inc/burgertech/features/burgertech-cta.php';
...
if ( ! function_exists( 'burger_companion_spintech_frontpage_sections' ) ) :
	function burger_companion_spintech_frontpage_sections() {	
	    ...
	    require BURGER_COMPANION_PLUGIN_DIR . 'inc/burgertech/sections/section-cta.php';
    }
