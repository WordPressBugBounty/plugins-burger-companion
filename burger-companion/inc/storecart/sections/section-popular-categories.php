<?php  
if ( ! function_exists( 'burger_storecart_popular_categories' ) ) :
    function burger_storecart_popular_categories() {
...
if ( function_exists( 'burger_storecart_popular_categories' ) ) {
    $section_priority = apply_filters( 'storex_section_priority', 11, 'burger_storecart_popular_categories' );
    add_action( 'storex_sections', 'burger_storecart_popular_categories', absint( $section_priority ) );
}