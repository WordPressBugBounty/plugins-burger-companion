...
require BURGER_COMPANION_PLUGIN_DIR . 'inc/corapress/sections/section-above-header.php';
...
require BURGER_COMPANION_PLUGIN_DIR . 'inc/cozipress/features/cozipress-info.php';
...
if ( ! function_exists( 'burger_companion_corapress_frontpage_sections' ) ) :
	function burger_companion_corapress_frontpage_sections() {	
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/corapress/sections/section-slider.php';
		require BURGER_COMPANION_PLUGIN_DIR . 'inc/corapress/sections/section-info.php';
	...
	add_action( 'cozipress_sections', 'burger_companion_corapress_frontpage_sections' );
endif;
